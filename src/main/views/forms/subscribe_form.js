            ...
            <div class="container">
                <div class="card-form">
                    ...
                    <div style="display: none;">
                        <label for='_id'>_id (hide me):</label>
                        <input type="text" class="form-control" _id="id" name="_id" automation-id="_id" value="${(values['_id'] || -1)}"/>
                        <br/>
                    </div>
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="subscribe"  name="subscribe" automation-id="subscribe" value="${values['subscribe']}" __onclick="checkme(this)" ${values['subscribe']}>
                        <label class="form-check-label" for="subscribe">Subscribe</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="requests-pilot" name="requests-pilot" automation-id="requests-pilot"  value="${values['requests-pilot']}"  __onclick="checkme(this)"   ${values['requests-pilot']}>
                    ...
                    <input class="subcribe-card-button" type="submit" id="'submitRequest" name="submitRequest" automation-id="sumitRequest" value="Subscribe">
