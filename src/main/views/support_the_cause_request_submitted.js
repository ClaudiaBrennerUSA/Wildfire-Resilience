class SupportTheCauseRequestSubmitted
{
    render = () =>
    {
        console.log(">>> SupportTheCauseRequestSubmitted::render()");
...
} // end class SupportTheCauseRequestSubmitted

module.exports = SupportTheCauseRequestSubmitted;