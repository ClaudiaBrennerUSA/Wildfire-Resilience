let generateHeader = (headerContainerElementId) =>
{
  ...
  <header>
    <div class="images-column">
      <div>
       <a href="/home">  <img src="assets/images/cd-logo.png" alt="CDlogo" class="top-left-image"> </a>
       <a href="/home">   <img src="assets/images/CWPCLogoW.png" alt="CWPC" class="top-right-image"> </a>
      </div>
      <div>
        <a href="/home">  <img src="assets/images/arise.png" alt="arise" class="centered-image"> </a>
      </div>
    </div>
    </a>
